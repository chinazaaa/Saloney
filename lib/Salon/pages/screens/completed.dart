...
class SalonCompletedOrders extends StatefulWidget {
  @override
  _SalonCompletedOrdersState createState() => _SalonCompletedOrdersState();
}

class _SalonCompletedOrdersState extends State<SalonCompletedOrders> {
  @override
  void initState() {
    super.initState();
